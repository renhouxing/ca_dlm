    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            attentions = attentions + (attn_weights.roll(1, dims=-2), )
...
class DreamForCausalLM(DreamPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = DreamForCausalLM.from_pretrained("Qwen/Dream-8B")
        >>> tokenizer = AutoTokenizer.from_pretrained("Qwen/Dream-8B")
        ...
        logits = self.lm_head(hidden_states).roll(1, dims=1)
        ...
        if labels is not None:
            ...
            if num_items_in_batch is None:
                loss = nn.functional.cross_entropy(logits_for_loss, labels)
            else:
                loss = nn.functional.cross_entropy(logits_for_loss, labels, reduction="sum") / num_items_in_batch
